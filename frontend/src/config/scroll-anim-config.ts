...
type SectionId = "hero" | "upload" | "render" | "classify" | "template" | "fitting" | "weighting" | "download";
...
const DESKTOP: Record<SectionId, SectionAnimConfig> = {
	...
	upload: section(
		{ posX: 2.0, rotY: -0.3, camX: 3.5, camY: 1.4, camZ: 5 },
		{ posX: 2.0, rotY: 0.2, camX: 3.5, camY: 1.4, camZ: 5 }
	),
	...
	classify: section(
		{ posX: -1.8, rotY: 0.2 + Math.PI * 2, camX: -2.0, camY: 1.5, camZ: 5 },
		{ posX: 2.0, rotY: 0.2 + Math.PI * 2 + 0.8, camX: 3.5, camY: 1.4, camZ: 4.5 }
	),
	// Template (text right) → model left
	template: section(
		{ posX: 2.0, rotY: 0.2 + Math.PI * 2 + 0.8, camX: 3.5, camY: 1.4, camZ: 4.5 },
		{ posX: -1.8, rotY: 0.2 + Math.PI * 2 + 1.5, camX: -2.0, camY: 1.4, camZ: 5 }
	),
	// Fitting (text left) → model right
	fitting: section(
		{ posX: -1.8, rotY: 0.2 + Math.PI * 2 + 1.5, camX: -2.0, camY: 1.4, camZ: 5 },
		{ posX: 2.0, rotY: 0.2 + Math.PI * 2 + 2.5, camX: 3.5, camY: 1.3, camZ: 4.5 }
	),
	// Weighting (text right) → model left
	weighting: section(
		{ posX: 2.0, rotY: 0.2 + Math.PI * 2 + 2.5, camX: 3.5, camY: 1.3, camZ: 4.5 },
		{ posX: -1.8, rotY: 0.2 + Math.PI * 2 + 3.3, camX: -2.0, camY: 1.5, camZ: 5 }
	),
	// Download (text left) → model right — skeleton here
	download: section(
		{ posX: -1.8, rotY: 0.2 + Math.PI * 2 + 3.3, camX: -2.0, camY: 1.5, camZ: 5 },
		{ posX: 2.0, rotY: 0.2 + Math.PI * 2 + 4.0, camX: 3.5, camY: 1.4, camZ: 5 }
	),
};
...
const TABLET: Record<SectionId, SectionAnimConfig> = {
	...
	render: section(
		{ posX: 1.2, rotY: 0.2, camX: 3, camY: 1.4, camZ: 5.5 },
		{ posX: -1.2, rotY: 0.2 + Math.PI * 2, camX: -1.5, camY: 1.5, camZ: 5.5 }
	),
	classify: section(
		{ posX: -1.2, rotY: 0.2 + Math.PI * 2, camX: -1.5, camY: 1.5, camZ: 5.5 },
		{ posX: 1.2, rotY: 0.2 + Math.PI * 2 + 0.8, camX: 3, camY: 1.4, camZ: 5 }
	),
	template: section(
		{ posX: 1.2, rotY: 0.2 + Math.PI * 2 + 0.8, camX: 3, camY: 1.4, camZ: 5 },
		{ posX: -1.2, rotY: 0.2 + Math.PI * 2 + 1.5, camX: -1.5, camY: 1.4, camZ: 5.5 }
	),
	fitting: section(
		{ posX: -1.2, rotY: 0.2 + Math.PI * 2 + 1.5, camX: -1.5, camY: 1.4, camZ: 5.5 },
		{ posX: 1.2, rotY: 0.2 + Math.PI * 2 + 2.5, camX: 3, camY: 1.3, camZ: 5 }
	),
	weighting: section(
		{ posX: 1.2, rotY: 0.2 + Math.PI * 2 + 2.5, camX: 3, camY: 1.3, camZ: 5 },
		{ posX: -1.2, rotY: 0.2 + Math.PI * 2 + 3.3, camX: -1.5, camY: 1.5, camZ: 5.5 }
	),
	download: section(
		{ posX: -1.2, rotY: 0.2 + Math.PI * 2 + 3.3, camX: -1.5, camY: 1.5, camZ: 5.5 },
		{ posX: 1.2, rotY: 0.2 + Math.PI * 2 + 4.0, camX: 3, camY: 1.4, camZ: 5.5 }
	),
};
...
const MOBILE: Record<SectionId, SectionAnimConfig> = {
	...
	render: section(
		{ posX: 0, rotY: 0.2, camX: 2.5, camY: 1.6, camZ: 6, scale: 0.85 },
		{ posX: 0, rotY: 0.2 + Math.PI * 2, camX: 2.5, camY: 1.7, camZ: 6, scale: 0.85 }
	),
	classify: section(
		{ posX: 0, rotY: 0.2 + Math.PI * 2, camX: 2.5, camY: 1.7, camZ: 6, scale: 0.85 },
		{ posX: 0, rotY: 0.2 + Math.PI * 2 + 0.8, camX: 2.5, camY: 1.6, camZ: 5.5, scale: 0.85 }
	),
	template: section(
		{ posX: 0, rotY: 0.2 + Math.PI * 2 + 0.8, camX: 2.5, camY: 1.6, camZ: 5.5, scale: 0.85 },
		{ posX: 0, rotY: 0.2 + Math.PI * 2 + 1.5, camX: 2.5, camY: 1.6, camZ: 6, scale: 0.85 }
	),
	fitting: section(
		{ posX: 0, rotY: 0.2 + Math.PI * 2 + 1.5, camX: 2.5, camY: 1.6, camZ: 6, scale: 0.85 },
		{ posX: 0, rotY: 0.2 + Math.PI * 2 + 2.5, camX: 2.5, camY: 1.5, camZ: 5.5, scale: 0.85 }
	),
	weighting: section(
		{ posX: 0, rotY: 0.2 + Math.PI * 2 + 2.5, camX: 2.5, camY: 1.5, camZ: 5.5, scale: 0.85 },
		{ posX: 0, rotY: 0.2 + Math.PI * 2 + 3.3, camX: 2.5, camY: 1.7, camZ: 6, scale: 0.85 }
	),
	download: section(
		{ posX: 0, rotY: 0.2 + Math.PI * 2 + 3.3, camX: 2.5, camY: 1.7, camZ: 6, scale: 0.85 },
		{ posX: 0, rotY: 0.2 + Math.PI * 2 + 4.0, camX: 2.5, camY: 1.6, camZ: 6, scale: 0.85 }
	),
};
...
export function lerpValues(
	...
	return {
		...
		floatIntensity: lerp(start.floatIntensity, end.floatIntensity, progress),
	};
}

export const SECTION_IDS: SectionId[] = [
	"hero", "upload", "render", "classify", "template", "fitting", "weighting", "download",
];
